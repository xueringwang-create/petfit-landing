...
【关于服装的还原要求 — 最高优先级】
必须精确复刻图2这件具体服装，包括：版型结构、颜色、图案花纹、装饰细节（蝴蝶结/蕾丝/纽扣/拉链/口袋等）、裙摆层数与轮廓、领口袖型。禁止替换成其他种类或风格的服装，禁止简化、省略或更改图2中的任何设计细节，最终穿在宠物身上的必须是图2展示的这件衣服，而不是相似风格的另一件衣服。

【关于宠物的还原要求】
宠物的脸部、眼睛、毛色、毛发纹理、耳朵形态、姿势动作、所在背景环境、光线效果须与图1完全一致，不得改变，不得添加图1和图2之外的配饰或物品。

【输出要求】
照片级真实效果，避免卡通化、避免肢体变形，最终结果是"图1的宠物穿着图2这件具体的服装"。`;
